import React, { CSSProperties, HTMLProps, MutableRefObject, createContext, useCallback, useContext, useMemo, useReducer } from 'react';

const DEFAULT_HEIGHT = 216;
const DEFAULT_ITEM_HEIGHT = 36;
const DEFAULT_WHEEL_MODE = 'off';
const DEFAULT_HIGHLIGHT_BACKGROUND = '#9ecdfc';
...
function PickerRoot<TType extends PickerValue>(props: PickerRootProps<TType>) {
  const {
    ...
    highlightBg = DEFAULT_HIGHLIGHT_BACKGROUND,
  ...
  const containerStyle = useMemo<CSSProperties>(
    () => ({
      ...
      WebkitMaskImage: 'linear-gradient(180deg,hsla(0,0%,100%,0.3) 0%,hsla(0,0%,100%,0.3) 20%,hsla(0,0%,100%,0.68) 37%,hsla(0,0%,100%,1) 50%,hsla(0,0%,100%,1) 56%,hsla(0,0%,100%,0.68) 62%,hsla(0,0%,100%,0.3) 100%)',
    }),
    [height],
  );
