...
-- 2. dashboard_widgets 字典扩展（5 种 widget）不是写入DB的，而是在前端定义
...
-- 3. 权限，已在018_add_notification_system.sql 中创建
-- INSERT IGNORE INTO `permissions` (`code`, `name`, `module`, `description`, `created_at`, `updated_at`) VALUES
...
-- 4. 已在018_add_notification_system.sql 中创建
-- INSERT IGNORE INTO `role_permissions` (`role_id`, `permission_id`)
-- SELECT r.id, p.id
-- FROM `roles` r, `admin_permissions` p
